...
$sql = "SELECT * FROM ratings WHERE ratings_this_month > 0 ORDER BY (pos_ratings_this_month)/(ratings_this_month) DESC LIMIT 50";
        ...
        <section class=" ">
            <div class="container">
                <div class="top-text text-left">
					<a href="https://open.spotify.com/playlist/3hVuauFhMdG1hNpmOKUk7t?si=87ad1056ffaf48df" target="_blank"><img src="images/gom.png" style="height:200px;width:200px;display:inline-block;" /></a>
                    <span style="display:inline-block;padding-left:10px"><h3 style="display:inline-block;">Gas of the Month</h3><br>
                    The top 100 songs based on their percentage gassed from votes cast this month</span>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table>
