...
$song_num = 1;
$sql = "SELECT songID, spotify_uri, song_pos_ratings FROM ratings WHERE song_total_ratings > 0 ORDER BY song_pos_ratings DESC LIMIT 50";
        ...
        <section class=" ">
            <div class="container">
                <div class="top-text text-left">
                    <a href="https://open.spotify.com/playlist/4RozhKyKT0abCAvpaehM7s?si=3d9bdf11471941de" target="_blank"><img src="images/mostgassed.png" style="height:200px;width:200px;display:inline-block;" /></a>
                    <span style="display:inline-block;padding-left:10px"><h3 style="display:inline-block;">Most Gassed Songs of All Time</h3><br>
                    Top songs based on raw number of Gassed ratings all time</span>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table>
                                    ...
                                    <td class="font-td">
                                        <?php 
                                            if (isset($_SESSION["userID"])) {
                                                ...
                                                echo "<img src=\"images/gas-icon.png\" class=\"rating-icon\"/><strong><span id=\"gasNum" . $songID . "\">" . intval($posRating) . "</span></strong>";
                                                ...
                                                echo '<a data-tooltip="Signin"><img data-tooltip="Signin" src="images/gas-icon.png" class="img-responsive" height="30"  /></a>'.intval($posRating);
