...
$sql = "SELECT * FROM ratings WHERE ratings_this_month > 0 ORDER BY ratings_this_month DESC LIMIT 50";
        ...
        <section class=" ">
            <div class="container">
                <div class="top-text text-left">
                    <a href="https://open.spotify.com/playlist/3jX6Kv8foxojVVqmzXK2NR?si=500d527042584509" target="_blank"><img src="images/trending.png" style="height:200px;width:200px;display:inline-block;" /></a>
                    <span style="display:inline-block;padding-left:10px"><h3 style="display:inline-block;">Trending Songs this Month</h3><br>
                    The most talked about songs this month, based on raw number of votes</span>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table>
                                    ...
                                    <td class="font-td">
                                        <?php 
                                            if (isset($_SESSION["userID"])) {
                                                ...
                                                if ($voterGassed) {
                                                    echo "<a href=\"add_rating.php?rating=gas&song=" . $songID . "\" target=\"target\"><img src=\"images/up-voted.png\" id=\"gasIcon" . $songID . "\" onclick=\"tranding_vote(" . $songID . ")\" class=\"vote-icon up-vote\"/></a>";
                                                }
                                                else {
                                                    echo "<a href=\"add_rating.php?rating=gas&song=" . $songID . "\" target=\"target\"><img src=\"images/up-vote.png\" id=\"gasIcon" . $songID . "\" onclick=\"tranding_vote(" . $songID . ")\" class=\"vote-icon up-vote\"/></a>";
                                                }

                                                echo "<strong><span id=\"gasNum" . $songID . "\" style=\"color:green\">" . $posRating . "</span> | <span id=\"trashNum" . $songID . "\" style=\"color:red\">" . $negRating . "</span></strong>";

                                                if ($voterTrashed) {
                                                    echo "<a href=\"add_rating.php?rating=trash&song=" . $songID . "\" target=\"target\"><img src=\"images/down-voted.png\" id=\"trashIcon" . $songID . "\" onclick=\"trending_del(" . $songID . ")\" class=\"vote-icon down-vote\"/></a>";
                                                }
                                                else {
                                                    echo "<a href=\"add_rating.php?rating=trash&song=" . $songID . "\" target=\"target\"><img src=\"images/down-vote.png\" id=\"trashIcon" . $songID . "\" onclick=\"trending_del(" . $songID . ")\" class=\"vote-icon down-vote\"/></a>";
                                                }
                                                ...
                                                echo '<span style="color:green;">'.$posRating.'</span>|<span style="color:red;">'.$negRating.'</span>';
        ...
        <script>
            function tranding_vote(songId){
                if(document.getElementById("gasIcon"+songId).src.includes("images/up-vote.png") && document.getElementById("trashIcon"+songId).src.includes("images/down-vote.png")){
                    ...
                    document.getElementById("gasNum"+songId).innerHTML = parseInt(document.getElementById("gasNum"+songId).innerHTML)+1;
                    ...
                    document.getElementById("gasNum"+songId).innerHTML = parseInt(document.getElementById("gasNum"+songId).innerHTML)+1;
                    document.getElementById("trashNum"+songId).innerHTML = parseInt(document.getElementById("trashNum"+songId).innerHTML)-1;
                }
            }
            function trending_del(songId){
