...
$song_num = 1;
$sql = "SELECT songID, spotify_uri, song_pos_ratings, song_total_ratings FROM ratings WHERE song_total_ratings > 0 ORDER BY (song_pos_ratings/song_total_ratings)*100 DESC LIMIT 100";
        ...
        <section class=" ">
            <div class="container">
                <div class="top-text text-left">
					<a href="https://open.spotify.com/playlist/00QW2oZQHoJRCdOYq605i8?si=00ad74f5786e4ce6" target="_blank"><img src="images/top100.png" style="height:200px;width:200px;display:inline-block;" /></a>
                    <span style="display:inline-block;padding-left:10px"><h3 style="display:inline-block;">Top 100 Songs of All Time</h3><br>
                    The Top 100 songs based on their percentage gassed all time</span>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table>
