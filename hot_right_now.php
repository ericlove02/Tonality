...
$song_num = 1;
$results = $api->getPlaylistTracks('spotify:playlist:37i9dQZF1DXcBWIGoYBM5M', ['limit' => 30]);
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-20 clickable-row" data-href="song?id=<?php echo $spotifyID; ?>"><?php if(strlen($trackName)<37){echo mb_substr($trackName,0,40,'utf-8');}else{ echo mb_substr($trackName,0,37,'utf-8') . "..."; } ?></td>
