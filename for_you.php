        ...
        <div class="row">
            <div class="col-md-12">
                <h2>Recommended For You
					 <svg onclick='reload()' class='refresh' style="font-size:32px;width:32px;height:32px;margin-top:-10px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 16 16">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-20 clickable-row" data-href="song?id=<?php echo $spotifyID; ?>"><?php if(strlen($trackName)<27){echo mb_substr($trackName,0,30,'utf-8');}else{ echo mb_substr($trackName,0,27,'utf-8') . "..."; }?></td>
                            <td class="font-20 clickable-row" data-href="song?id=<?php echo $spotifyID; ?>"><?php if(strlen($trackArtist)<15){echo mb_substr($trackArtist,0,15,'utf-8');}else{ echo mb_substr($trackArtist,0,12,'utf-8') . "..."; } ?></td>
                            <td>
