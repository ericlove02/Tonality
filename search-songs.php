<?php
    ...
    if (isset($_GET["keyword"]) && $_GET["keyword"] != "") {
        ...
        $results = $api->search($keyword_from_search, ['track'], ['limit' => 50]);
    }
    else {
        echo "<h3>Use the search bar to find songs</h3>";
    }
    $songList = array();
?>
<!DOCTYPE html>
        ...
        <div class="main-container">
            <section>
                <div class="container">
                                ...
                                <form class="text-left row mx-0" name="search" value="<?php echo $_GET["keyword"] ?>" id="search" action="">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="search-options" id="dropdown" onchange="changeAction(this)">
                                            ...
                                            <option value="search-songs?keyword=" selected>Song Names</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h2>Use the search bar to find songs</h2>
