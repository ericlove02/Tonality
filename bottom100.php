...
$song_num = 1;
$sql = "SELECT songID, spotify_uri, song_pos_ratings, song_total_ratings FROM ratings WHERE song_total_ratings > 0 ORDER BY (song_pos_ratings/song_total_ratings)*100 ASC LIMIT 100";
...
$songs1 = array_slice($songs, 0, 50);
$songs2 = array_slice($songs, 50);
$tracks = $api->getTracks($songs1);
$index = 0;
        ...
        <section class=" ">
            <div class="container">
                <div class="top-text text-left">
					<a href="https://open.spotify.com/playlist/68AVxW4J25g9Cp6J4skm2y?si=7a719c632ad242bf" target="_blank"><img src="images/bottom100.png" style="height:200px;width:200px;display:inline-block;" /></a>
                    <span style="display:inline-block;padding-left:10px"><h3 style="display:inline-block;">Bottom 100 Songs of All Time</h3><br>
                    The Bottom 100 songs based on their percentage gassed all time</span>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="font-20 clickable-row" data-href="artist?id=<?php echo $artistID; ?>"><?php echo $trackArtist; ?></td>
                                    <td>
                                        ...
                                        <?php 
                                            if (isset($_SESSION["userID"])) {
                                                ...
                                                if (get_rating_no_pop($posRating, $totRating) >= 60) {
                                                    echo "<img height='30' src=\"images/gas-icon.png\" class=\"rating-icon\"/><strong>" . get_rating_no_pop($posRating, $totRating) . "%</strong>";
                                                }
                                                elseif (get_rating_no_pop($posRating, $totRating) <= 60) {
                                                    echo "<img height='30' src=\"images/trash-icon.png\" class=\"rating-icon\"/><strong>" . get_rating_no_pop($posRating, $totRating) . "%</strong>";
                                                }
