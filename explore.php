...
<html lang="en">
    ...
    <div id="coverScreen"  class="LockOn">
        <img src="images/loading.gif" />
			...
			<section class="padding-bottom-0" style="margin-top:-54px">
				<div class="container">
					<div class="row">
					<h1 style="<?php if($isMobile){ echo 'margin-top:-20px'; } ?>">Explore Tonality</h1>
						<div class="col-md-12 col-12">
							<div class="slider slider--columns is-hidden" data-arrows="<?php if($isMobile){ echo 'false'; }else{ echo 'true'; } ?>" data-paging="true" style="<?php if($isMobile){ echo 'width:100vw;margin-left:-30px'; } ?>">
							
							<h2>Charts</h2>
								<ul class="slides">
									<li class="col-md-4 col-4">
										<a class="clickable-row" data-href="top100">
											<img alt="Cover Image" src="images/top100.png" />
										</a>
										<p>Top 100</p>
									</li>
									<li class="col-md-4 col-4">
										<a class="clickable-row" data-href="bottom100">
											<img alt="Cover Image" src="images/bottom100.png" />
										</a>
										<p>Bottom 100</p>
									</li>
									<li class="col-md-4 col-4">
										<a class="clickable-row" data-href="most-gassed">
											<img alt="Cover Image" src="images/mostgassed.png" />
										</a>
										<p>Most Gassed</p>
									</li>
									<li class="col-md-4 col-4">
										<a class="clickable-row" data-href="most-trashed">
											<img alt="Cover Image" src="images/mosttrashed.png" />
										</a>
										<p>Most Trashed</p>
									</li>
									<li class="col-md-4 col-4">
										<a class="clickable-row" data-href="trending-this-month">
											<img alt="Cover Image" src="images/trending.png" />
										</a>
										<p>Trending</p>
									</li>
									<li class="col-md-4 col-4">
										<a class="clickable-row" data-href="gas-of-the-month">
											<img alt="Cover Image" src="images/gom.png" />
										</a>
										<p>Gas of the Month</p>
									</li>
									<li class="col-md-4 col-4">
										<a class="clickable-row" data-href="trash-of-the-month">
											<img alt="Cover Image" src="images/tom.png" />
										</a>
										<p>Trash of the Month</p>
									</li>
								</ul>
							</div>
							...
							$seeds = array();
							if(isset($_SESSION['signed_in']) && $_SESSION['signed_in'] && $usersqli->query("SELECT song_id FROM user_votes WHERE vote_by=" . $_SESSION["userID"])->num_rows > 0){
        ...
        ?>
		<script async>
		modalOpen = function(btn){
			var buttonId = $(btn).attr('id');
			console.log(buttonId);
			var button = document.getElementById(buttonId);
			var spotId = buttonId.substring(7);
			console.log('widget-placeholder-' + spotId);
			document.getElementById('widget-placeholder-' + spotId).innerHTML = '<iframe style="min-height: unset;" height="80px" src="https://open.spotify.com/embed/track/'+spotId+'" id="widget-'+spotId+'" width="300" frameborder="0" allowtransparency="true" allow="encrypted-media" loading="lazy"></iframe>';
			document.getElementById('modal-' + spotId).style.display = "block";
			document.getElementById('cover-bkg-' + spotId).style.display = '';
			document.getElementsByTagName('body')[0].style.overflow = 'hidden';
		}
		modalClose = function(btn){
			var buttonId = $(btn).attr('id');
			var button = document.getElementById(buttonId);
			var spotId = buttonId.substring(6);
			document.getElementById('widget-placeholder-' + spotId).innerHTML = '';
			document.getElementById('modal-' + spotId).style.display = "none";
			document.getElementById('cover-bkg-' + spotId).style.display = 'none';
			document.getElementsByTagName('body')[0].style.overflow = 'visible';
		}
		modalClickedOff = function(spotId){
			document.getElementById('widget-placeholder-' + spotId).innerHTML = '';
			document.getElementById('modal-' + spotId).style.display = "none";
			document.getElementById('cover-bkg-' + spotId).style.display = 'none';
			document.getElementsByTagName('body')[0].style.overflow = 'visible';
		...
		$(window).scroll(function(){
			if (elementInView($('.explore-trigger'))){
				$('.explore-trigger').removeClass("explore-trigger");
				console.log('load more content');
				$.ajax({
					type: "POST",
					url: "load_more_explore.php"
