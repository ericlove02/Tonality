...
include "db_userdata_connect.php";
	...
	unset($posRatings);
	unset($totRatings);
	$trashedListResults = $usersqli->query("SELECT song_id FROM user_votes WHERE vote_by=" . $_POST["profile-id"] . " AND vote_type=False ORDER BY voted_at DESC LIMIT ". $_POST['start_num'].", 50");
