...
$result = $usersqli->query("SELECT * FROM data WHERE LOWER(user_name)=\"" . strtolower($user_name) . "\" OR email=\"" . $email . "\"");
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        elseif (strtolower($row["user_name"]) == strtolower($user_name)) {
            $usersqli->close();
            header('Location: /signup?error=user');
        }
    }
}
else {
    ...
    $sql = "INSERT INTO `data`(`userID`, `user_name`, `email`, `password`, `first_name`, `last_name`, `user_image`, `user_date`, user_level) VALUES 
		(NULL,'" . $user_name . "','" . $email . "','" . $user_password . "','" . $first_name . "','" . $last_name . "','" . $image . "','" . $datetime . "', 0)";
...
<amp-img src="https://imgur.com/dS3TIf9" alt style="display: block" width="130" height="123"></amp-img></td> </tr> </table></td> </tr> </table></td> </tr> </table></td> </tr> </table> <table cellpadding="0" cellspacing="0" class="es-content" align="center"> <tr> <td align="center" bgcolor="#f8f9fd" style="background-color: #f8f9fd"> <table bgcolor="transparent" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: transparent"> <tr> <td class="es-p20t es-p10b es-p20r es-p20l" align="left"> <table cellpadding="0" cellspacing="0" width="100%"> <tr> <td width="560" align="center" valign="top"> <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> <tr> <td align="center" class="es-p10b"><h1>Welcome to Tonality!</h1></td> </tr> <tr>
 <td align="center" class="es-p10t es-p10b"><p>We\'re so excited to have you!</p></td> </tr> </table></td> </tr> </table></td> </tr> <tr> <td class="es-p15t es-m-p15t es-m-p0b es-m-p0r es-m-p0l" align="left"> <table cellpadding="0" cellspacing="0" width="100%"> <tr> <td width="600" align="center" valign="top"> <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> <tr> <td align="center" style="font-size: 0px"><amp-img class="adapt-img" src="https://imgur.com/ENjChsd" alt style="display: block" width="600" height="150" layout="responsive"></amp-img></td> </tr> </table></td> </tr> </table></td> </tr> </table></td> </tr> </table> <table cellpadding="0" cellspacing="0" class="es-content" align="center"> <tr>
 <td align="center" bgcolor="#071f4f" style="background-color: #071f4f;background-image: url(https://nzhnlu.stripocdn.email/content/guids/CABINET_1ce849b9d6fc2f13978e163ad3c663df/images/10801592857268437.png);background-repeat: no-repeat;background-position: center top"> <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600"> <tr> <td class="es-p40t es-p40b es-p30r es-p30l" align="left"> <table cellpadding="0" cellspacing="0" width="100%"> <tr> <td width="540" align="center" valign="top"> <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> <tr> <td align="center" height="20"></td> </tr> <tr> <td align="left" class="es-p10b"><h1 style="text-align: center;color: #ffffff">Tonality - Interact with your Music</h1></td> </tr> <tr> <td align="center" class="es-p10t es-p10b"><p style="color: #ffffff">
Tonality is the best place to interact with your music, whether that be through our charts or user forums!</p></td> </tr> </table></td> </tr> </table></td> </tr> </table></td> </tr> </table> <table cellpadding="0" cellspacing="0" class="es-content" align="center"> <tr> <td align="center" bgcolor="#f8f9fd" style="background-color: #f8f9fd;background-image: url(https://nzhnlu.stripocdn.email/content/guids/CABINET_1ce849b9d6fc2f13978e163ad3c663df/images/83191592482092483.png);background-repeat: no-repeat;background-position: center center"> <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600"> <tr> <td class="es-p40t es-p15b es-p20r es-p20l" align="left"> <table cellpadding="0" cellspacing="0" width="100%"> <tr> <td width="281" align="center" valign="top"> <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> <tr> <td align="left"><h1 style="text-align: center">
Your new Account</h1></td> </tr> <tr> <td align="center" class="es-m-txt-c es-p15t"><p style="font-size: 16px">Thank you for creating an account with us. Your information is listed below.</p></td> </tr> </table></td> </tr> </table></td> </tr> <tr> <td class="es-p20t es-p20r es-p20l" align="left"> <table cellpadding="0" cellspacing="0" width="100%"> <tr> <td width="560" align="center" valign="top"> <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> <tr> <td align="center" class="es-m-txt-c es-p15t"><p style="font-size: 16px">Name: ' . $name . '<br>Username: ' . $user_name . '<br>Email: ' . $email . '<br><br>This information can be changed in your profile menu</p></td> </tr> <tr> <td align="center" class="es-p20" style="font-size:0"> <table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation"> <tr> <td style="border-bottom: 1px solid #cccccc;background:none;height:1px;width:100%;margin:0px 0px 0px 0px"></td> </tr> </table></td> </tr> </table></td>
...
';
    ...
    $mail->Subject = 'Welcome to Tonality!';
    $mail->Body = $email_body;
    $mail->AltBody = 'Welcome to Tonality! Here is your user information: Name: ' . $name . ' Username: ' . $user_name . ' Email: ' . $email;
	...
	header('Location: login?message=new');
}
