                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <?php
                                $followers = $usersqli->query("SELECT follower_id FROM follows WHERE following_id=".$_GET['id']. " ORDER BY followed_at DESC");
                            ?>
                            <div class="boxed boxed--lg boxed--border">
                                <div id="gassed_songs" class="account-tab">
                                    <h4><?php echo $name; ?>'s Followers</h4>
                                    <?php if($followers->num_rows > 0){ ?>
                                    	<table>
			                                <tbody>
			                                  <?php while($followRow = $followers->fetch_assoc()){ 
			                                  		$user = $followRow['follower_id'];
                                    ...
                                    <?php } else { ?>
                                    	<p class="lead">This user has no followers</p>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
